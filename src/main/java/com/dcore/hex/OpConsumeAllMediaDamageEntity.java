 ...
 * 输入：单个实体
 * 消耗：背包中所有可用的媒体
 * 伤害：根据每种媒体类型的血量扣除比例计算总伤害
 */
public class OpConsumeAllMediaDamageEntity implements ConstMediaAction {
    public static final OpConsumeAllMediaDamageEntity INSTANCE = new OpConsumeAllMediaDamageEntity();
